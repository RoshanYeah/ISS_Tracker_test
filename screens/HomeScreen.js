...
import {Text, View, StyleSheet, SafeAreaView, Platform, StatusBar, Image, ImageBackground, TouchableOpacity} from "react-native" 
            ...
            <View style={styles.container}>
                ...
                <ImageBackground style={styles.backgroundImage} source={require("../assets/assets/bg_image.png")}>
                    ...
                    <TouchableOpacity style={styles.routeCard} onPress={ ()=>{
                        ...
                        <Image style={styles.iconImage} source={require("../assets/assets/iss_icon.png")}/>
                    </TouchableOpacity>
                    <TouchableOpacity style={styles.routeCard} onPress={ ()=>{
                        ...
                        <Text style={styles.knowMore}>{"know more -->"}</Text>
                        <Text style={styles.bgDigit}>1</Text>
                        <Image style={styles.iconImage} source={require("../assets/assets/meteor_icon.png")}/>
                    </TouchableOpacity>
                </ImageBackground>
            </View>
        )
